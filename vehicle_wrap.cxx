...
#define SWIGTYPE_p_Vehicle swig_types[0]
...
SWIGEXPORT SEXP
R_swig_Vehicle_Axles ( SEXP self, SEXP s_swig_copy)
{
  {
    int result;
    ...
    res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Vehicle, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Vehicle_Axles" "', argument " "1"" of type '" "Vehicle *""'"); 
    }
    arg1 = reinterpret_cast< Vehicle * >(argp1);
    result = (int)(arg1)->Axles();
...
SWIGEXPORT SEXP
R_swig_Vehicle_Available_set ( SEXP self, SEXP s_Available)
{
  {
    Vehicle *arg1 = (Vehicle *) 0 ;
    bool arg2 ;
    ...
    res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Vehicle, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Vehicle_Available_set" "', argument " "1"" of type '" "Vehicle *""'"); 
    }
    arg1 = reinterpret_cast< Vehicle * >(argp1);
    arg2 = LOGICAL(s_Available)[0] ? true : false;
...
SWIGEXPORT SEXP
R_swig_Vehicle_Available_get ( SEXP self, SEXP s_swig_copy)
{
  {
    bool result;
    Vehicle *arg1 = (Vehicle *) 0 ;
    ...
    res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Vehicle, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Vehicle_Available_get" "', argument " "1"" of type '" "Vehicle *""'"); 
    }
    arg1 = reinterpret_cast< Vehicle * >(argp1);
...
{
  {
    ...
    r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Vehicle, SWIG_POINTER_OWN |  0 );
    vmaxset(r_vmax);
    if(r_nprotect)  Rf_unprotect(r_nprotect);
...
SWIGEXPORT SEXP
R_swig_new_Vehicle__SWIG_1 ( SEXP ax)
{
  {
    Vehicle *result = 0 ;
    int arg1 ;
    ...
    arg1 = static_cast< int >(INTEGER(ax)[0]);
    result = (Vehicle *)new Vehicle(arg1);
    r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Vehicle, SWIG_POINTER_OWN |  0 );
    vmaxset(r_vmax);
    if(r_nprotect)  Rf_unprotect(r_nprotect);
...
SWIGEXPORT SEXP
R_swig_delete_Vehicle ( SEXP self)
{
  {
    Vehicle *arg1 = (Vehicle *) 0 ;
    void *argp1 = 0 ;
    ...
    res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Vehicle, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
   {"R_swig_new_Vehicle__SWIG_0", (DL_FUNC) &R_swig_new_Vehicle__SWIG_0, 0},
   {"R_swig_new_Vehicle__SWIG_1", (DL_FUNC) &R_swig_new_Vehicle__SWIG_1, 1},
   {"R_swig_Vehicle_Axles", (DL_FUNC) &R_swig_Vehicle_Axles, 2},
   {"R_swig_Vehicle_Available_set", (DL_FUNC) &R_swig_Vehicle_Available_set, 2},
   {"R_swig_delete_Vehicle", (DL_FUNC) &R_swig_delete_Vehicle, 1},
   {"R_swig_Vehicle_Available_get", (DL_FUNC) &R_swig_Vehicle_Available_get, 2},
   {NULL, NULL, 0}
};

extern "C" SWIGEXPORT void R_init_vehicle(DllInfo *dll) {
